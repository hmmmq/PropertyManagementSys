        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-10" style="align-items: center;" v-show="addbill">
                    <button type="button" class="btn btn-outline-success waves-effect waves-light m-1"
                        @click="addbill = false">收起面板</button>
                    <ChargeFee></ChargeFee>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-table"></i>收费列表</div>
                        <div class="card-body">

                            <div class="table-responsive">
                                <table id="example112" class="table table-bordered">
...
import ChargeFee from './ChargeFee.vue';
import $ from 'jquery';
...
export default {
    ...
    methods: {
        ...
        async initializeDataTable() {
            ...
            var billlist2d = null;
            try {
                if (!$.fn.DataTable.isDataTable('#example112')) {


                    try {
                        const promise = await axios.get('http://localhost:8086/fee/');
                    ...
                    this.$nextTick(() => {
                        console.log(" var table = $('#example112').DataTable({");
                        var table = $('#example112').DataTable({
