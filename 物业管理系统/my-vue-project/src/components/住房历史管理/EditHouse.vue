                ...
                <div class="card col-lg-12">
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label>入住时间</label>
                                <input type="date" class="form-control" placeholder="请填写入住时间" v-model="house.enterTime">
                            </div>
                            <div class="form-group">
                                <label>离开时间</label>
                                <input type="date" class="form-control" placeholder="请填写离开时间" v-model="house.leaveTime">
                            </div>
                            <div class="form-group">
                                <label>房屋类型</label>
    ...
    data() {
        return {
            house: {
                ...
                enterTime: this.initialhouse.enterTime || '',
                leaveTime: this.initialhouse.leaveTime || ''
            },
