                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group">
                                <label>报修ID</label>
                                <input type="text" class="form-control" placeholder="请填写报修ID" v-model="this.fix.id">
                            </div>
                            <div class="form-group">
                                <label>报修用户ID</label>
                                <input type="text" class="form-control" placeholder="报修用户ID" v-model="this.fix.userid"
                                    disabled>
                            </div>
                            <div class="form-group">
                                <label>报修类型</label>
                                <select class="form-control" v-model="this.fix.type">
                            ...
                            <div class="form-group">
                                <label>报修金额(元)</label>
                                <input type="number" class="form-control" placeholder="填写报修金额"
                                    v-model="this.fix.amount">
                            </div>
                            <div class="form-group">
                                <label>报修期限</label>
                                <input type="date" class="form-control" placeholder="填写报修期限"
                                    v-model="this.fix.deadline">
                            </div>
